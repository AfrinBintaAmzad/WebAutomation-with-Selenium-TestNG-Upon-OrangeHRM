...
public class PIMTestRunner extends Setup {
    ...
    @Test(priority = 1, description = "A user cannot register in using invalid credentials")
    ...
    @Test(priority = 2, description = "A user can register in using valid credentials.")
    ...
    @Test(priority = 4, description = "Creating first employee")
    public void createEmployee1() throws InterruptedException, IOException, ParseException {
        ...
        int empId = Utils.generateRandomNumber(10000, 99999);
        String employeeId = String.valueOf(empId);
        String username = "Julekha" + Utils.generateRandomNumber(1000, 9999);
        String password = "julekha@234";
    ...
    @Test(priority = 5, description = "Creating second employee")
    public void createEmployee2() throws InterruptedException, IOException, ParseException {
        ...
        int empId = Utils.generateRandomNumber(10000, 99999);
        String employeeId = String.valueOf(empId);
        String username = "Ataur" + Utils.generateRandomNumber(1000, 9999);
        String password = "ataur@234";
    ...
    @Test(priority = 6, description = "Searching Using an Invalid Employee's Name")
    ...
    @Test(priority = 7, description = "Searching Using an valid Employee's Name")
    ...
    @Test(priority = 8, description = "Update the user ID using a random ID")
    ...
    @Test(priority = 9, description = "Search using the current Employee ID")
