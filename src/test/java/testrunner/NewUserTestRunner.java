...
import pages.UsersInformationPage;
import setup.Setup;
import utils.Utils;
...
public class NewUserTestRunner extends Setup {
    ...
    LoginPage loginPage;
    UsersInformationPage userInfoPage;
    @Test(priority = 1, description = "Login Using a Second User")
    ...
    @Test(priority = 2, description = "Insert the gender, blood type, address, and email of the second user.")
    public void updateUserInformation() throws IOException, ParseException, InterruptedException {
        userInfoPage=new UsersInformationPage(driver);
